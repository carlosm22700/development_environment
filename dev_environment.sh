...
# Preface: If you'd like, I've created this script for your convenience that installs all development requirements, but below is a guide you can follow for a step-by-step process.
...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    echo "Please switch to the Intel guide."
    exit 1
fi
...
# Reminder to set up global .gitignore and GitHub credentials
echo "Global .gitignore set up."
echo "You were also prompted for GitHub credentials. Make sure you had them ready."
